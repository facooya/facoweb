...
var related_menu_container_name_list=["[V1.1.2A] Chapter 1","[V1.1.2A] Chapter 2","[V1.1.2A] Chapter 3"];
/* ------------------------------ */
/* --- Item Name List ---!!! Check List B !!! *//* +++ CN == Container Name +++ */
var _CN1_item_name_list=["[Chapter 1] Version 1.1.2 Alpha","[Chapter 1] Item 1-2"];
...
var _CN1_item_link_list=["./document_page_v1.1.2a.html","./document_page_v1.1.2a.html"];
var _CN2_item_link_list=["./document_page_v1.1.2a.html"];
var _CN3_item_link_list=["./document_page_v1.1.2a.html"];
