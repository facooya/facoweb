...
import {genMenu2} from "./gen-util";
genDMC();
function genDMC() {
  const _DD = new DmcData();
  const _PARENT = document.getElementById("dev-menu-cmp");
  genMenu2(
    "dmc",
    _DD._DMC_CONTAINER_NAME_LIST,
    _DD._DMC_ITEM_NAME_LIST,
    _DD._DMC_ITEM_LINK_LIST,
    _PARENT
  );
  console.log("DMC DONE");
}
/* INFORMATION
