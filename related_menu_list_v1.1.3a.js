...
var related_menu_container_name_list=["[V1.1.3A] Chapter 1","[V1.1.3A] Chapter 2","[V1.1.3A] Chapter 3"];
/* ------------------------------ */
/* --- Item Name List ---!!! Check List B !!! *//* + CN == Container Name + */
var _CN1_item_name_list=["[Chapter 1] Version 1.1.3 Alpha","[Chapter 1] Item 1-2"];
...
var _CN1_item_link_list=["./document_page_v1.1.3a.html","./document_page_v1.1.3a.html"];
var _CN2_item_link_list=["./document_page_v1.1.3a.html"];
var _CN3_item_link_list=["./document_page_v1.1.3a.html"];
...
<nav id="related_menu_section">
  ...
  <ul class="related_menu_container">
    ...
    <li><a class="related_menu_item">RM Item Name 1-1</a></li>
