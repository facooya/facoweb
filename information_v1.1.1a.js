...
var menu_box_array=document.getElementsByClassName("facooya_menu_container");
var detail_menu_box_array=document.getElementsByClassName("related_menu_container");
var tbg_facooya_menu_line_graphic=document.getElementsByClassName("tbg_facooya_menu_line_graphic"); /*- Graphic -*/
var tbg_related_menu_line_graphic=document.getElementsByClassName("tbg_related_menu_line_graphic"); /*- Graphic -*/
...
var tbg_facooya_menu_graphic=document.getElementById("tbg_facooya_menu_graphic"); /*- Graphic -*/
var tbg_related_menu_graphic=document.getElementById("tbg_related_menu_graphic"); /*- Graphic -*/
...
function right_menu_click(){
  ...
  if(right_menu_click_check==0){ /*= Right Menu Open =*/
    ...
    if(size_load_check==1){
      facooya_menu_section.style.right="0rem";
...
function left_menu_click(){
  ...
  if(left_menu_click_check==0){ /*= Left Menu Open =*/
    ...
    if(size_load_check==1){ /*- Size Desktop ? Mobile ? -*/
      related_menu_section.style.left="0rem";
...
function side_menu_add(){
  ...
  tbg_facooya_menu_graphic.addEventListener("click",right_menu_click);
  tbg_related_menu_graphic.addEventListener("click",left_menu_click);
  //!!!
...
function desktop(){
  ...
  related_menu_section.style.left="-20rem";
  facooya_menu_section.style.transition="right 0ms";
  related_menu_section.style.transition="left 0ms";
  /*------------------------------*/
  /* !!!!! Footer */
  facooya_menu_section.style.marginBottom="3.5rem";
  related_menu_section.style.marginBottom="3.5rem";
