...
class BodyUtil {
  static setDeviceState() {
    BodyUtilSet.setDeviceState();
  }
  /* -------------------------------------------------- */
  static getGenerateElement(elementGroup, pIndex = []) {
    return BodyUtilGet.getGenerateElement(elementGroup, pIndex);
  }
  static getElementCache(pCache, pGroup, pRoot, pIndex) {
    return BodyUtilGet.getElementCache(pCache, pGroup, pRoot, pIndex);
  }
  static getEventData(eventData, targetQuery) {
    return BodyUtilGet.getEventData(eventData, targetQuery);
  }
  static getDisplayType() {
    return BodyUtilGet.getDisplayType();
  }
  static getPageType() {
    return BodyUtilGet.getPageType();
  }
  /* -------------------------------------------------- */
  /* static getCache(pElement) {
    return BodyUtilGet.getCache(pElement);
  } */
}
export {
  BodyUtil
