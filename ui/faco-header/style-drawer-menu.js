...
/* ClassList */
.drawer-menu .fog-top.active {
	transform: scaleY(1);
}
.drawer-menu .fog-bottom.active {
	transform: scaleY(1);
}
...
.drawer-menu .sub-item-bottom-line.active {
	transform: scaleX(1);
}
...
@media (hover: hover) {
	...
	.drawer-menu .sub-item-box:hover .sub-item-bottom-line {
		transform: scaleX(1);
	}
}
`);
